  ...
  const productCategories = [
    {
      ...
      title: 'Anti-allergic',
      description: 'Comprehensive range of anti-allergic medications for various allergic conditions and reactions.',
      color: 'bg-blue-100 text-blue-600'
    },
    {
      icon: <Heart className="h-8 w-8" />,
      title: 'Nutrition Supplements',
      description: 'High-quality nutrition supplements for all age groups, supporting overall health and wellness.',
      color: 'bg-green-100 text-green-600'
    },
    {
      icon: <Zap className="h-8 w-8" />,
      title: 'Pain Management',
      description: 'Effective pain management solutions including analgesics and anti-inflammatory medications.',
      color: 'bg-red-100 text-red-600'
    },
    {
      icon: <Pill className="h-8 w-8" />,
      title: 'Antibiotics',
      description: 'Wide selection of antibiotics for treating bacterial infections and related conditions.',
      color: 'bg-purple-100 text-purple-600'
    },
    {
      icon: <Plus className="h-8 w-8" />,
      title: 'Other Pharmaceutical Products',
      description: 'Additional pharmaceutical products across various therapeutic categories and specializations.',
